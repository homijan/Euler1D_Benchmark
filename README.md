...
$`dU = T dS - p dV \Rightarrow dS = \frac{1}{T} dU + \frac{p}{T} dV \overset{dU = c_v N k_B dT}{\Rightarrow} dS = \frac{c_v N k_B}{T} dT + \frac{p}{T} dV \overset{p V = N k_B T}{\Rightarrow} dS = \frac{C_v}{T} dT + \frac{N k_B}{V} dV`$
